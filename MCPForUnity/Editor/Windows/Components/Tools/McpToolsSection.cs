...
namespace MCPForUnity.Editor.Windows.Components.Tools
{
    ...
    public class McpToolsSection
    {
        ...
        private VisualElement CreateBatchExecuteSettings()
        {
            ...
            {
                value = McpMath.Clamp(currentValue, 1, BatchExecute.AbsoluteMaxCommandsPerBatch),
                style = { width = 60 }
            };
            ...
            {
                int clamped = McpMath.Clamp(evt.newValue, 1, BatchExecute.AbsoluteMaxCommandsPerBatch);
